...
class Book extends \App\Entity\Book implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'author', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'year', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'edition', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'users'];
        }
     ...
     * {@inheritDoc}
     */
    public function setId(?int $id): \App\Entity\Book
    {
     ...
     * {@inheritDoc}
     */
    public function setEdition(string $edition): \App\Entity\Book
    {
     ...
     * {@inheritDoc}
     */
    public function setUsers(array $users): \App\Entity\Book
    {
